...
import { McqAnswer, McqSection } from './mcq-section'
...
const Solutions: React.FC<SolutionsProps> = ({ setView, currentLanguage, setLanguage, mcqMode }) => {
  ...
  const [mcqs, setMcqs] = useState<McqAnswer[] | null>(null)
  ...
  useEffect(() => {
    ...
    const cached = queryClient.getQueryData(['solution']) as
      | {
          mode?: 'mcq'
          code?: string
          thoughts?: string[]
    ...
    const unsubscribe = queryClient.getQueryCache().subscribe((event) => {
      ...
      if (event?.query.queryKey[0] === 'solution') {
        ...
        if (solution?.mode === 'mcq') {
          setMcqs(solution.mcqs || null)
          setSolutionData(null)
          setThoughtsData(null)
          setTimeComplexityData(null)
          setSpaceComplexityData(null)
  ...
  useEffect(() => {
    ...
    const cleanupFunctions = [
      ...
      window.electronAPI.onSolutionSuccess((data) => {
        ...
        if (data.mode === 'mcq') {
          const solutionData = { mode: 'mcq' as const, mcqs: data.mcqs as McqAnswer[] }
          queryClient.setQueryData(['solution'], solutionData)
          setMcqs(solutionData.mcqs || null)
          setSolutionData(null)
          setThoughtsData(null)
          setTimeComplexityData(null)
          setSpaceComplexityData(null)
      ...
      {!isResetting && queryClient.getQueryData(['new_solution']) ? (
        ...
        <div className="relative" ref={contentRef}>
          <div className="space-y-3 px-4 py-3">
            ...
            {mcqMode && (
              <McqSection title="MCQ Answers" mcqs={mcqs} isLoading={!mcqs && !debugProcessing} />
            )}
